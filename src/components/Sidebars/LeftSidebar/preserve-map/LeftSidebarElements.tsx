...
export const SidebarSubTitleText = styled.div`
  ...
  export const SidebarTextItem = styled.div`
    ...
    @media (max-width: 768px) { font-size: 0.80rem; }
    @media (max-width: 480px) { font-size: 0.765rem; }
    @media (max-width: 350px) { font-size: 0.6rem; }
  `;
    ...
    export const SidebarParkingTextElement = styled.div`
      font-size: 16px;
      font-weight: 400;
    ...
    export const ParkingLocationLink = styled.a`
      font: inherit;       
      color: #585858;
